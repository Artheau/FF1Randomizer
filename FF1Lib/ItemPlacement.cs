		...
		protected override ItemPlacementResult DoSanePlacement(MT19337 rng, ItemPlacementContext ctx)
		{
			...
			do
			{
				...
				if (((bool)_flags.NPCItems) || ((bool)_flags.NPCFetchItems))
				{
					...
					List<Item> unrestricted = new List<Item> { Item.Key, Item.Floater };
					...
					List<Item> fixedPlacements = new List<Item> { Item.Ship, Item.Key, Item.Bridge, Item.Canoe };
					List<Item> nextPlacements = new List<Item> { Item.Canal };
